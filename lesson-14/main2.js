...
const port = 3000,
  ...
  Subscirber = require("./models/subscriber"),
  app = express();
...
mongoose.connect(
  "mongodb+srv://seungsi:TNDLgbfZzRNZxP0L@ut-node.8n0krvz.mongodb.net/?retryWrites=true&w=majority&appName=ut-node/ut-node",// URL
